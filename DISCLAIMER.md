...
`the-binding-of-agents` is an unofficial fan project. It is not affiliated with, endorsed by, or sponsored by Edmund McMillen, Nicalis, or any other rights holder of The Binding of Isaac franchise.
...
If you are a rights holder and would like content removed, file an issue at https://github.com/yonatankarp/the-binding-of-agents/issues with the subject "Takedown request". Offending content will be removed within seven days of receipt.
